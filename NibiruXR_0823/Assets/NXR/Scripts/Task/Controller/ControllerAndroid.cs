...
namespace NibiruTask
{
    ...
    static class GetAndroid
    {
        ...
        static GetAndroid()
            ...
            if(usbClass == null) usbClass = new AndroidJavaClass("ruiyue.controller.sdk.ControllerUnity");///参数为安卓包名，根据不同包具体设置
            if(usbContext == null) {
	...
	public static float[] getCPoseEvent(int type,int deviceId)
	{
        ...
        {
#if UNITY_EDITOR
            if (NxrPlayerCtrl.Instance != null && NxrPlayerCtrl.Instance.debugInEditor) return true;
#endif
