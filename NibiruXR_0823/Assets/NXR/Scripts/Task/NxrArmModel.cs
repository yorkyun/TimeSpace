...
namespace NibiruTask
{
    public class NxrArmModel : NxrBaseArmModel
    {
        ...
        private NxrTrackedDevice nvrTrackedDevice;
        ...
        protected virtual void UpdateHandedness()
        {
            ...
            //判断手柄是否为空
            if (NxrPlayerCtrl.Instance == null || !NxrPlayerCtrl.Instance.IsQuatConn())
            {
                return;
            }
        ...
        protected virtual void UpdateTorsoDirection(bool forceImmediate)
        {
            ...
            bool IsQuatConn = NxrPlayerCtrl.Instance != null && NxrPlayerCtrl.Instance.IsQuatConn();
        ...
        protected void GetControllerRotation(out Quaternion rotation, out Quaternion xyRotation, out float xAngle)
        {
            bool IsQuatConn = NxrPlayerCtrl.Instance != null && NxrPlayerCtrl.Instance.IsQuatConn();
            //设置角度
            rotation = IsQuatConn ? NxrPlayerCtrl.Instance.mTransform.rotation : Quaternion.identity;
